...
<div class="container-fluid bg2 text-center" id="formacao">
  <h3> <i class="bi bi-easel"></i> Caronas agendadas </h3>
  <ul class="list-group lista" style="color:#222;">
    <li class="list-group-item"> Carona 1</li>
    <li class="list-group-item"> Carona 2</li>
    <li class="list-group-item"> Carona 3</li>
  </ul>
  <br>
  <h3> <i class="bi bi-book"></i> Veículos </h3>
  <ul class="list-group lista" style="color:#222;">
    <li class="list-group-item"> Veículos 1</li>
    <li class="list-group-item"> Veículos 2</li>
    <li class="list-group-item"> Veículos 3</li>
  </ul>
  <br>
  <a href="#" class="btn btn-light btn-lg bt">
    <i class="bi bi-arrow-up-circle"></i> Topo
