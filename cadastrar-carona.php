  ...
  <div class="container-fluid bg1 text-center" id="quem">
    ...
    <form action="acoes/cria-usuario.php" method="POST" class="needs-validation container" novalidate onSubmit="return validaCampoSenha()">
      ...
      <div class="row g-12">
        ...
        <div class="col-sm-12">
          <label for="locais" class="form-label">Itinerário</label>
          <input type="text" class="form-control" id="locais" name="locais" placeholder="Seu itinerário aqui" value="" autofocus required>
          <div class="invalid-feedback">
            Digite o itinerário da corrida.
          </div>
        </div>

        <div class="col-md-12">
          <label for="quantidade" class="form-label">Quantidade de pessoas</label>
          <input type="number" class="form-control" id="quantidade" name="quantidade" placeholder="Quantidade de pessoas aqui" min="1" max="8" step="1" required>
          <div class="invalid-feedback">
            Informe o máximo de pessoas.
          </div>
        </div>

        <div class="col-md-12">
          <label for="inicio" class="form-label">Horário de início</label>
          <input type="time" class="form-control" id="inicio" name="inicio" placeholder="10:00" required>
          <div class="invalid-feedback">
            Digite que horas inícia a corrida.
          </div>
        </div>
      </div>
      <br>
